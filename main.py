...
# ds_dengue = (
#     pipeline
#     | "Dengue Dataset read" >> ReadFromText('alura-apachebeam-basedados/casos_dengue.txt', skip_header_lines=1)
...
ds_chuvas = (
    pipeline
    | "Chuvas Dataset read" >> ReadFromText('alura-apachebeam-basedados/chuvas.csv', skip_header_lines=1)
    | "Convert text to list" >> beam.Map(lambda element: element.split(','))
